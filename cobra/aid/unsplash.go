...
func buildURL(params model.UnsplashRandomPhotoParameters, profile string) string {
...
func DownloadPhoto(params model.UnsplashRandomPhotoParameters, profile string) error {
	url := buildURL(params, profile)
